...
List<Map> schemes = [
  {
    ...
    "platforms": {
      "@type": "pubspecTerminalLibraryPlatforms",
      "android": null,
      "ios": null,
      "linux": null,
      "macos": null,
    ...
    "environment": {
      "@type": "pubspecTerminalLibraryEnvironment",
      "sdk": ">=2.18.5 <3.0.0",
    },
    "dependencies": {
      "@type": "pubspecTerminalLibraryDependencies",
      "flutter": {
        "@type": "pubspecTerminalLibraryDependenciesExtra",
        "sdk": "flutter",
      },
    ...
    "dev_dependencies": {
      ...
      "test": "^1.16.0",
      "packagex": {
        "@type": "pubspecTerminalLibraryDevDependenciesExtra",
        "path": "../",
      },
      "msix": "^1.0.6"
    },
