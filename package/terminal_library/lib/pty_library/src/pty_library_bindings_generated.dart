...
///
class FlutterPtyLibraryBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  FlutterPtyLibraryBindings(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterPtyLibraryBindings.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
  ...
  ffi.Pointer<PtyLibraryHandle> pty_create(
    ffi.Pointer<PtyLibraryOptions> options,
  ) {
    return _pty_create(
      options,
    );
  ...
  late final _pty_createPtr = _lookup<ffi.NativeFunction<ffi.Pointer<PtyLibraryHandle> Function(ffi.Pointer<PtyLibraryOptions>)>>('pty_create');
  late final _pty_create = _pty_createPtr.asFunction<ffi.Pointer<PtyLibraryHandle> Function(ffi.Pointer<PtyLibraryOptions>)>();

  void pty_write(
    ffi.Pointer<PtyLibraryHandle> handle,
  ...
  late final _pty_writePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<PtyLibraryHandle>, ffi.Pointer<ffi.Char>, ffi.Int)>>('pty_write');
  late final _pty_write = _pty_writePtr.asFunction<void Function(ffi.Pointer<PtyLibraryHandle>, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _pty_ack_readPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<PtyLibraryHandle>)>>('pty_ack_read');
  late final _pty_ack_read = _pty_ack_readPtr.asFunction<void Function(ffi.Pointer<PtyLibraryHandle>)>();
  ...
  late final _pty_resizePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<PtyLibraryHandle>, ffi.Int, ffi.Int)>>('pty_resize');
  late final _pty_resize = _pty_resizePtr.asFunction<int Function(ffi.Pointer<PtyLibraryHandle>, int, int)>();
  ...
  late final _pty_getpidPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<PtyLibraryHandle>)>>('pty_getpid');
  late final _pty_getpid = _pty_getpidPtr.asFunction<int Function(ffi.Pointer<PtyLibraryHandle>)>();

  ffi.Pointer<ffi.Char> pty_error() {
    return _pty_error();
  }

  late final _pty_errorPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('pty_error');
  late final _pty_error = _pty_errorPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
}

typedef Dart_PostCObject_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port_DL port_id, ffi.Pointer<Dart_CObject> message)>>;
...
typedef Dart_HandleFinalizer = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> isolate_callback_data, ffi.Pointer<ffi.Void> peer)>>;
...
typedef Dart_NativeMessageHandler_DL = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Port_DL dest_port_id, ffi.Pointer<Dart_CObject> message)>>;
...
typedef Dart_IsApiError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle handle)>>;
typedef Dart_IsUnhandledExceptionError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle handle)>>;
typedef Dart_IsCompilationError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle handle)>>;
...
typedef Dart_ErrorHasException_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle handle)>>;
typedef Dart_ErrorGetException_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle handle)>>;
typedef Dart_ErrorGetStackTrace_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle handle)>>;
typedef Dart_NewApiError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> error)>>;
typedef Dart_NewCompilationError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> error)>>;
...
typedef Dart_HandleFromWeakPersistent_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_WeakPersistentHandle object)>>;
...
typedef Dart_DeletePersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle object)>>;
typedef Dart_NewWeakPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<Dart_WeakPersistentHandle Function(ffi.Handle object, ffi.Pointer<ffi.Void> peer, ffi.IntPtr external_allocation_size, Dart_HandleFinalizer callback)>>;
typedef Dart_DeleteWeakPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle object)>>;
typedef Dart_UpdateExternalSize_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle object, ffi.IntPtr external_allocation_size)>>;
typedef Dart_NewFinalizableHandle_Type = ffi.Pointer<ffi.NativeFunction<Dart_FinalizableHandle Function(ffi.Handle object, ffi.Pointer<ffi.Void> peer, ffi.IntPtr external_allocation_size, Dart_HandleFinalizer callback)>>;
typedef Dart_FinalizableHandle = ffi.Pointer<_Dart_FinalizableHandle>;

final class _Dart_FinalizableHandle extends ffi.Opaque {}

typedef Dart_DeleteFinalizableHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle object, ffi.Handle strong_ref_to_object)>>;
typedef Dart_UpdateFinalizableExternalSize_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle object, ffi.Handle strong_ref_to_object, ffi.IntPtr external_allocation_size)>>;
...
typedef Dart_ExitScope_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;

final class PtyLibraryOptions extends ffi.Struct {
  @ffi.Int()
  external int rows;
...
final class PtyLibraryHandle extends ffi.Opaque {}
