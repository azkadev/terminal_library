...
class PubspecTerminalLibrary extends JsonScheme {
  ...
  static Map get defaultData {
    return {"@type":"pubspecTerminalLibrary","name":"example","description":"A sample command-line application.","version":"0.0.0","publish_to":"none","homepage":"https://youtube.com/{youtube_owner_username}","repository":"https://github.com/{main_username_owner}/packagex.git","issue_tracker":"https://github.com/{main_username_owner}/terminal_library/issues","documentation":"https://github.com/{main_username_owner}/terminal_library/tree/main/docs","funding":["https://github.com/sponsors/{main_username_owner}"],"platforms":{"@type":"pubspecTerminalLibraryPlatforms","android":null,"ios":null,"linux":null,"macos":null,"web":null,"windows":null},"environment":{"@type":"pubspecTerminalLibraryEnvironment","sdk":">=2.18.5 <3.0.0"},"dependencies":{"@type":"pubspecTerminalLibraryDependencies","flutter":{"@type":"pubspecTerminalLibraryDependenciesExtra","sdk":"flutter"},"cupertino_icons":"^1.0.2"},"dev_dependencies":{"@type":"pubspecTerminalLibraryDevDependencies","lints":"^2.0.0","test":"^1.16.0","packagex":{"@type":"pubspecTerminalLibraryDevDependenciesExtra","path":"../"},"msix":"^1.0.6"},"terminal_library":{"@type":"packageFullTemplatePubspecConfig"}};
  }
