...
import 'package:terminal_library/api/terminal_library_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  TerminalLibraryDartApi packageFullTemplateDartApi = TerminalLibraryDartApi();
  ...
  TerminalLibraryDartBuildType server_universeDartBuildType = TerminalLibraryDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = TerminalLibraryDartBuildType.debug;
  }
