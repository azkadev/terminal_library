...
import 'package:terminal_library_scheme/scheme/scheme/terminal_library_pubspec_config.dart';
import 'package:terminal_library_scheme/scheme/scheme/pubspec_terminal_library.dart';
import 'package:terminal_library_scheme/scheme/scheme/pubspec_terminal_library_dependencies.dart';
...
class TerminalLibraryDartApi {
  TerminalLibraryDartApi();
  ...
  FutureOr<dynamic> create({
    ...
    await file_guide.writeAsString(guide_terminal_library_markdown());
    ...
    if (!file_script_example.existsSync()) {
      // await file_script_example.writeAsString(script_terminal_library_native());
    }
  ...
  FutureOr<int> run({
    required Directory directoryBase,
    required Directory? directoryOutputBuildTerminalLibrary,
    required String? inputFileName,
    required TerminalLibraryDartBuildType server_universeDartBuildType,
  }) async {
    if (Dart.isWeb) {
      return 1;
    }
  ...
  static String guide_terminal_library_markdown() {
    return r"""
